"""
Alembic migration environment for Goldbeck Optimizer.

Supports both sync (offline) and async (online) migrations
against SQLite (dev) and PostgreSQL (future prod).
"""
import os
import sys
...
# Override URL from environment if available (same logic as engine.py)
